/**
 * Constantes de identidade do site, centralizadas para serem reaproveitadas em
 * metadata (layout.tsx), sitemap.ts, robots.ts, JSON-LD e nas imagens de OG —
 * evita repetir a URL de produção e o texto institucional em vários arquivos.
 */
